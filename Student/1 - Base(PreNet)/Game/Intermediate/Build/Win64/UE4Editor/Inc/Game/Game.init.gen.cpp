	...
	UPackage* Z_Construct_UPackage__Script_Game()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Game_OnDeathSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Game_OnWeaponFiredSignature__DelegateSignature,
			};
